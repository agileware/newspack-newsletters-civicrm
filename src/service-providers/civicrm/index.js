...
const getFetchDataConfig = ( { postId } ) => ( {
	path: `/newspack-newsletters/v1/civicrm/${ postId }`,
} );
...
const renderPreSendInfo = ( newsletterData = {} ) => (
	<p>
		{ __( 'Sending newsletter to:', 'newspack-newsletters' ) } { newsletterData.recipient_count }
		{ __( ' recipients', 'newspack-newsletters' ) }
	</p>
);
